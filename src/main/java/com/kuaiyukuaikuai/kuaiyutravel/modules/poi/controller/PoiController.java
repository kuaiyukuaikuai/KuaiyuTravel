...
public class PoiController {
    ...
    public Result queryPoiById(@PathVariable("id") Long id) {
        return Result.ok(poiService.queryPoiById(id));
    }
     ...
     */
    @PostMapping
    public Result savePoi(@RequestBody @Valid Poi poi) {
     ...
     */
    @PutMapping
    public Result updatePoi(@RequestBody @Valid Poi poi) {
        // 写入数据库
    ...
    public Result queryPoiByType(
        ...
        return Result.ok(poiService.queryPoiByType(typeId, current, x, y));
    }
